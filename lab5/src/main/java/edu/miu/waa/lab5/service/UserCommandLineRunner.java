...
public class UserCommandLineRunner implements CommandLineRunner {
    ...
    private void setData() {
        ...
        PostUser postUser = new PostUser("Amr", List.of(post,post3));
        userRepository.save(postUser);

        PostUser postPostUser2 = new PostUser("ahmed", List.of(post2));
        userRepository.save(postPostUser2);


        PostUser postPostUser3 = new PostUser("elsayed", Collections.emptyList());
        userRepository.save(postPostUser3);
    }
}
